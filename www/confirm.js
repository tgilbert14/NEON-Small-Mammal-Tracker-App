  ...
  $(document).on("click", "#help", function () {
    Swal.fire({
      ...
      html:
        ...
        "<div style='color:#5eead4;font-weight:700;margin-bottom:6px'>RARITY — set by total captures</div>" +
        ...
        keyRow("#2dd4bf", "🔵 Rare", "6–9 captures") +
        keyRow("#5fb56a", "🟢 Uncommon", "3–5 captures") +
        keyRow("#9fb0cf", "▫ Common", "1–2 captures") +
        "</div>" +
        "<div style='color:#5eead4;font-weight:700;margin:14px 0 6px'>CHONK INDEX</div>" +
